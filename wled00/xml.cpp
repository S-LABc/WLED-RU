...
void getSettingsJS(byte subPage, char* dest)
{
  ...
  if (subPage == 1)
  {
    ...
    {
      sappends('m',SET_F("(\"sip\")[0]"),(char*)F("Не подключен"));
    }
    ...
    {
      sappends('m',SET_F("(\"sip\")[1]"),(char*)F("Не активен"));
    }
  }
  ...
  if (subPage == 4)
  {
    ...
    sappends('s',SET_F("BK"),(char*)((blynkEnabled)?SET_F("Скрыт"):""));
    ...
    switch (hueError)
    {
      case HUE_ERROR_INACTIVE     : strcpy(hueErrorString,(char*)F("Неактивный"));              break;
      case HUE_ERROR_ACTIVE       : strcpy(hueErrorString,(char*)F("Активный"));                break;
      case HUE_ERROR_UNAUTHORIZED : strcpy(hueErrorString,(char*)F("Неавторизованный"));        break;
      case HUE_ERROR_LIGHTID      : strcpy(hueErrorString,(char*)F("Неверный ID светильника")); break;
      case HUE_ERROR_PUSHLINK     : strcpy(hueErrorString,(char*)F("Кнопка ссылки не нажата")); break;
      case HUE_ERROR_JSON_PARSING : strcpy(hueErrorString,(char*)F("Ошибка анализа JSON"));     break;
      case HUE_ERROR_TIMEOUT      : strcpy(hueErrorString,(char*)F("Ожидание"));                break;
      default: sprintf(hueErrorString,(char*)F("Ошибка Моста %i"),hueError);
    }
  ...
  if (subPage == 5)
  {
    ...
    if ((int)(longitude*10.) || (int)(latitude*10.)) {
      sprintf_P(tm, PSTR("Восход: %02d:%02d Закат: %02d:%02d"), hour(sunrise), minute(sunrise), hour(sunset), minute(sunset));
