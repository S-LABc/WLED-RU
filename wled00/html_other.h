...
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><body>Страница с расширениями пользователя не настроена.
</body></html>)=====";


// Autogenerated from wled00/data/msg.htm, do not edit!!
const char PAGE_msg[] PROGMEM = R"=====(<!DOCTYPE html><html><html lang="ru"><head><meta content="width=device-width" 
name="viewport" charset="utf-8"><title>Сообщение WLED</title><script>
...
charset="utf-8"><title>Карта DMX</title><script>
...
charset="utf-8"><title>Обновление WLED</title><script>
...
</style></head><body><h2>Обновление прошивки WLED</h2><form method="POST" 
action="/update" id="uf" enctype="multipart/form-data" onsubmit="U()">
Версия установленной прошивки: 0.13.1<br>Скачайте последнюю версию прошивки: <a 
href="https://github.com/Aircoookie/WLED/releases" target="_blank"><img 
src="https://img.shields.io/github/release/Aircoookie/WLED.svg?style=flat-square">
</a><br><input type="file" class="bt" name="update" required><br><input 
type="submit" class="bt" value="Обновить!"><br><button type="button" class="bt" 
onclick="B()">Назад</button></form><div id="msg"><b>Обновляюсь...</b><br>
Пожалуйста, не закрывайте и не перезагружайте страницу :)</div></body></html>)=====";
...
content="#222222"><title>Добро пожаловать!</title><style>
...
<div class="main"><h1>Добро пожаловать в WELD!</h1><h3>
Спасибо за установку моего приложения!</h3><b>Дальнейшие действия:</b><br><br>
Подключите модуль к Wi-Fi роутеру!<br><button 
onclick='window.location.href="/settings/wifi"'>Настройки WiFi</button><br><i>
Попробовать в режиме точки доступа?</i><br><button 
onclick='window.location.href="/sliders"'>К управлению!</button><br></div>
</body></html>)=====";
...
content="width=device-width" name="viewport"><meta name="theme-color" 
content="#222222"><title>Страница не найдена</title><style>
...
<h1>Ошибка 404</h1><b>Акеми не знает, куда вы направляетесь...</b><br><br>
<button onclick='window.location.href="/sliders"'>Вернуться к управлению
</button></body></html>)=====";
