...
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><body>Не настроена пользовательская страница usermod.
</body></html>)=====";
...
<title>Сообщение WLED</title><script>
...
Версия установленной прошивки: 0.12.0<br>Скачайте последнюю версию прошивки: <a 
href="https://github.com/Aircoookie/WLED/releases" target="_blank"><img 
src="https://img.shields.io/github/release/Aircoookie/WLED.svg?style=flat-square">
</a><br><input type="file" class="bt" name="update" accept=".bin" required><br>
<input type="submit" class="bt" value="Обновить!"><br><button type="button" 
class="bt" onclick="B()">Назад</button></form><div id="msg"><b>Обновление...</b>
<br>Пожалуйста, не закрывайте и не обновляйте страницу :)</div></body></html>)=====";
...
content="width=device-width" name="viewport"><meta name="theme-color" 
content="#222222"><title>Не найдено</title><style>
